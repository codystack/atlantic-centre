...
<head>
  <!-- Title -->
  <title>Atlantic Shopping & Entertainment Centre&trade;</title>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" href="https://i.imgur.com/y8E0RF6.png">
        ...
        <nav class="js-mega-menu navbar navbar-expand-lg u-header__navbar">
          ...
          <div class="u-header__navbar-brand-wrapper">
            <a class="navbar-brand u-header__navbar-brand" href="\" aria-label="Space">
              <img class="u-header__navbar-brand-default" src="https://i.imgur.com/gAd0MMX.png" style="height: 70px;" alt="Logo">
              <img class="u-header__navbar-brand-mobile" src="https://i.imgur.com/gAd0MMX.png" style="height: 50px;" alt="Logo">
            </a>
          </div>
          <!-- End Logo -->
          ...
          <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse py-0">
            ...
            <li class="nav-item hs-has-sub-menu u-header__nav-item"
                ...
                <a id="homeMegaMenu" class="nav-link u-header__nav-link" href="javascript:;"
                   ...
                   aria-labelledby="homeSubMenu">
                  Directories
                    <i class="fa fa-angle-down u-header__sub-menu-nav-link-icon"></i>
                </a>
                ...
                <ul id="homeSubMenu" class="list-inline hs-sub-menu u-header__sub-menu mb-0" style="min-width: 220px;"
                  ...
                  <li class="dropdown-item hs-has-sub-menu">
                    <a id="navLinkHomeClassic" class="nav-link u-header__sub-menu-nav-link" href="shopping.php"
                       aria-haspopup="true"
                       aria-expanded="false"
                ...
                <li class="nav-item hs-has-sub-menu u-header__nav-item"
                  ...
                  data-animation-in="fadeInUp"
                  data-animation-out="fadeOut">
                <a id="homeMegaMenu" class="nav-link u-header__nav-link" href="visit-us"
                   aria-haspopup="true"
                   aria-expanded="false"
                   aria-labelledby="homeSubMenu">
                  Visit us
