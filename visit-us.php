    ...
    <div class="container space-2 space-3--lg">
      <div class="row">
        <div class="col-lg-6 mb-7 mb-lg-0">
          <!-- Contacts Info -->
          <h1 class="h4 mb-4">Find us here</h1>
          ...
          <div class="row">
            <div class="col-sm-6 mb-4 mb-sm-0">
              ...
              <address class="mb-0">
                <ul class="list-unstyled font-size-14 text-secondary mb-0">
                  ...
                  <li class="py-2"></li>
                  <li class="py-1">Tel: <a href="tel:+2349082909799">+234 908 290 9799</a></li>
                  <li class="py-1">Email: <a href="mailto:info@atlanticcentreng.com">info@atlanticcentreng.com</a></li>
                  <li class="py-1">Website: <a href="www.atlanticcentreng.com">www.atlanticcentreng.com</a></li>
                </ul>
              </address>
            </div>
            ...
            <div class="col-sm-6">
              ...
              <img class="img-fluid" src="https://i.imgur.com/QWfBLL6.jpg" alt="Image Description">
            </div>
          </div>
          <!-- End Contacts Info -->
        </div>
